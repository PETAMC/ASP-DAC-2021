...
void MB0::Execute()
{
    ...
    {   
        ...
        //ABS
        buff_xa = this->ReadTokens(read_xa, write_xa, buff_xa, 0, 1, t_r_loop);
        buff_ya = this->ReadTokens(read_ya, write_ya, buff_ya, 0, 1, t_r_loop);
...
{ 
    ...
    {   
        ...
        buff_gx = this->WriteTokens(read_gx, write_gx, buff_gx, 0, 9, t_w_loop);
        buff_gy = this->WriteTokens(read_gy, write_gy, buff_gy, 0, 9, t_w_loop);
...
void MB2::Execute()
{
    ...
    {  
        // GX
        buff_gx = this->ReadTokens(read_gx, write_gx, buff_gx, 0, 9, t_r_loop);
        sc_core::wait(DelayGX_EA.GetDelay());
        buff_xa = this->WriteTokens(read_xa, write_xa, buff_xa, 0, 1, t_w_loop);
...
void MB3::Execute()
{
    ...
    {
        // GY
        buff_gy = this->ReadTokens(read_gy, write_gy, buff_gy, 0, 9, t_r_loop);
        sc_core::wait(DelayGY_EA.GetDelay());
        buff_ya = this->WriteTokens(read_ya, write_ya, buff_ya, 0, 1, t_w_loop);
    }   
}
